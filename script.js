$(document).ready(function() {
  ...
  function trickStyle(){
    document.getElementById('trick').style.textDecoration="underline";
    document.getElementById('trick').style.textDecorationColor="#eee";
    // document.getElementById('trick').style.fontSize="11pt";    
  }

  function noTrickStyle(){
    document.getElementById('trick').style.textDecoration="none";
    // document.getElementById('trick').style.fontSize="10pt";  
    // document.getElementById('trick').style.textDecorationColor="#eee";
  }

  function juggleStyle(){
    document.getElementById('juggling').style.textDecoration="underline";
    document.getElementById('juggling').style.textDecorationColor="#eee";
    // document.getElementById('trick').style.fontSize="11pt";    
  }

  function noJuggleStyle(){
    document.getElementById('juggling').style.textDecoration="none";
    // document.getElementById('trick').style.fontSize="10pt";  
    // document.getElementById('trick').style.textDecorationColor="#eee";
  }
...
// function hideYourCode(){

//   // document.getElementById('see-code').style.display="none";
// }
...
function hideDown(){
  document.getElementById('thing39').style.color="transparent";
    ...
    // function coverBrackets(){
    //     document.getElementById('thing24').style.color="transparent";
    // }
  // 
